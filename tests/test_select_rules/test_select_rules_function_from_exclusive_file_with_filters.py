...
class TestSelectRulesFromExlusiveFile(unittest.TestCase):
    ...
    def test_FFFF_00(self):
        ...
        configuration_file = {
                ...
                "Warnings": False,
                "SkipRulesFilePath": "",
                "ExclusiveRulesFilePath": "exclusive_rules.txt",
    ...
    def test_FFTF_02(self):
        ...
        self.config.read(configuration_file)
        selected_rules = select_rules(self.rules, self.config)
        self.assertCountEqual([rule_warning_test2,
    ...
    def test_FFTT_03(self):
        ...
        self.config.read(configuration_file)
        selected_rules = select_rules(self.rules, self.config)
        self.assertCountEqual([rule_warning_test3], selected_rules)
    ...
    def test_FTFF_04(self):
        ...
        self.assertCountEqual([rule_error_test1,
                               rule_error_test2], selected_rules)
    ...
    def test_FTFT_05(self):
        ...
        self.config.read(configuration_file)
        selected_rules = select_rules(self.rules, self.config)
        self.assertCountEqual([rule_error_test2], selected_rules)
    ...
    def test_TFFT_09(self):
        ...
        self.config.read(configuration_file)
        selected_rules = select_rules(self.rules, self.config)
        self.assertCountEqual([rule_notcategorized_test1], selected_rules)
    ...
    def test_TFTT_11(self):
        ...
        self.config.read(configuration_file)
        selected_rules = select_rules(self.rules, self.config)
        self.assertCountEqual([rule_warning_test3,
                               rule_notcategorized_test1], selected_rules)
...
if __name__ == "__main__":
    ...
    suite = unittest.TestLoader().loadTestsFromTestCase(TestSelectRulesFromExlusiveFile)
